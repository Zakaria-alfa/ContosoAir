[![Build Status](https://dev.azure.com/ALFARAGUIZAKARIA/ContosoAir/_apis/build/status/Zakaria-alfa.ContosoAir?branchName=master)](https://dev.azure.com/ALFARAGUIZAKARIA/ContosoAir/_build/latest?definitionId=4&branchName=master)
